...
public static class PacketAuthority
{
    private static readonly IReadOnlyDictionary<PacketType, PacketAuthorityDefinition> Definitions =
        new[]
        {
            ...
            Define(PacketType.CurrencyAdjust, ClientPacketRule.Allowed, PacketDirection.Bidirectional, PacketReliabilityProfile.Reliable, HostPacketAction.ValidateApplyAndBroadcast, PacketStateCoverage.Covered, PacketStateCoverage.Covered),
