...
public static class PacketAuthority
{
    private static readonly IReadOnlyDictionary<PacketType, PacketAuthorityDefinition> Definitions =
        new[]
        {
            ...
            Define(PacketType.WorldTime, ClientPacketRule.ServerOnly, PacketDirection.ServerToAllClients, PacketReliabilityProfile.ReliableOrdered, HostPacketAction.None, PacketStateCoverage.NotCovered, PacketStateCoverage.NotCovered),
